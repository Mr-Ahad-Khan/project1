    ...
    <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center gap-3 px-4 py-3 sm:px-6">
        ...
        <div className="ml-auto hidden items-center gap-3 md:flex">
          {isLoggedIn ? (
            <button
              className="h-11 rounded-md border border-gray-200 px-5 text-sm font-bold text-gray-900 hover:bg-gray-50"
              type="button"
              onClick={onLogout}
            >
              Logout
            ...
            <Link
              to="/login"
              className="h-11 flex items-center rounded-md border border-gray-200 px-5 text-sm font-bold text-gray-900 hover:bg-gray-50"
            >
              Login
            </Link>
          )}
