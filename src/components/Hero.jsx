...
const slides = [
  {
    ...
    subtitle:
      "Explore hand-picked products made for comfort, quality, and modern living.",
    image:
  ...
  },
  {
    ...
    subtitle:
      "Upgrade your collection with trending picks and limited-time deals.",
    image:
  ...
  },
  {
    ...
    subtitle:
      "Find everyday essentials with premium quality and easy checkout.",
    image:
    ...
    <section className="w-full bg-gray-50">
            ...
            <div key={slide.title}>
              ...
              >
                <div className="max-w-2xl text-white">
                  ...
                  <p className="mt-4 text-base leading-7 text-gray-100 md:text-xl">
                    {slide.subtitle}
                  </p>
      ...
      <div className="mx-auto grid max-w-6xl gap-6 px-6 py-12 md:grid-cols-3">
        {cards.map((card) => (
          <div
            key={card.title}
            className="rounded-md bg-white p-6 shadow-md transition hover:-translate-y-1 hover:shadow-lg"
          >
